...
class WebhookController extends Controller
{
    public function handle(Request $request)
    {
        try {
            ...
            savelog("Marientek webhook all the data", "WebhookController", $data);
            ...
            savelog("Webhook completed the work...", "WebhookController", $data);
            return response()->json(['status' => 'success'], 200);
        } catch (\Exception $e) {
            savelog($e->getMessage(), "WebhookController");
        }
    }
    ...
    protected function handleOrderRefunded($orderData)
    {
        try {
            ...
            savelog($e->getMessage(), "handle order refund function WebhookController");
        }
    }
