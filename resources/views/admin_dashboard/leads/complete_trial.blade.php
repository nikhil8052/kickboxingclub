...
<script>
     $(document).ready(function () {
          ...
          $('#filter').on('click', function(){
               ...
               completeTrialsFilter(location, startDate, endDate);
          });

          function completeTrialsFilter(location, startDate, endDate) {
               $('#overlay').show();
               var data = {
               ...
               $.ajax({
                    ...
                    success: function(response) {
                         ...
                         updatecompleteTrialsTable(response.data);
                         $('#overlay').hide();
                    },
          ...
          function updatecompleteTrialsTable(data) {
          ...
          $('#export-button').on('click', function () {
               ...
               if (link.download !== undefined) { 
                    ...
                    link.setAttribute('download', 'Complete_Trials_Not_Members_Export.csv');
          ...
          completeTrialsFilter('', moment().year(2020).month(0).date(1).format('YYYY-MM-DD'), moment().endOf('month').format('YYYY-MM-DD'));
    });
</script>
